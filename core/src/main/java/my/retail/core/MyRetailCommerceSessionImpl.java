...
public class MyRetailCommerceSessionImpl extends AbstractJcrCommerceSession {
    ...
    private static final Map<String, BigDecimal> shippingCosts = new HashMap<String, BigDecimal>() {
        ...
        private static final long serialVersionUID = 3324673759813249079L;
        {
            ...
            put("/var/commerce/shipping-methods/my-retail/standard-shipping", new BigDecimal("5.00"));
            put("/var/commerce/shipping-methods/my-retail/ground-shipping", new BigDecimal("10.00"));
            put("/var/commerce/shipping-methods/my-retail/two-business-day", new BigDecimal("15.00"));
            put("/var/commerce/shipping-methods/my-retail/one-business-day", new BigDecimal("25.00"));
        }
    };

    public MyRetailCommerceSessionImpl(AbstractJcrCommerceService commerceService,
                                  SlingHttpServletRequest request,
                                  SlingHttpServletResponse response,
                                  Resource resource) throws CommerceException {
        super(commerceService, request, response, resource);
        PN_UNIT_PRICE = MyRetailProductImpl.PN_PRICE;
    }
