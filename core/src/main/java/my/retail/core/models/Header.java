...
public class Header {
    ...
    public static final String ACCOUNT_PATH = "/content/my-retail/us/en/user/account";
    public static final String DEFAULT_ROOT_PATH = "/content/my-retail/us/en/";
    ...
    private void initModel() {
        try {
            ...
            root = MyRetailHelper.findRoot(resourcePage);
            languageRoot = "#";
            if (root != null) {
