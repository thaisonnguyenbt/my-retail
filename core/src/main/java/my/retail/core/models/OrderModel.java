...
public class OrderModel extends ShoppingCartModel {
    ...
    private String getAddress(String prefix) {
        ...
        String firstname = getOrderProperty(prefix + MyRetailConstants.FIRST_NAME);
        String lastname = getOrderProperty(prefix + MyRetailConstants.LAST_NAME);
        String street1 = getOrderProperty(prefix + MyRetailConstants.STREET_LINE1);
        String street2 = getOrderProperty(prefix + MyRetailConstants.STREET_LINE2);
        String zipCode = getOrderProperty(prefix + MyRetailConstants.ZIP_CODE);
        String city = getOrderProperty(prefix + MyRetailConstants.CITY);
        String state = getOrderProperty(prefix + MyRetailConstants.STATE);
        String country = getOrderProperty(prefix + MyRetailConstants.COUNTRY);
