...
package my.retail.core.productrelationships;
 ...
 */
@Component(label = "My.Retail Similar-to-Current Recommendations Provider",
...
public class SimilarToCurrentRelationshipsProvider extends AbstractRelationshipsProvider {
    ...
    public static final String RELATIONSHIP_TYPE = "my-retail.similar-to-current";
    ...
    protected List<ProductRelationship> calculateRelationships(SlingHttpServletRequest request, CommerceSession session,
        ...
        final Page root = MyRetailHelper.findRoot(currentPage);
        if (root != null) {
