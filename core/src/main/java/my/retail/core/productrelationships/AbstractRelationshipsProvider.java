...
/**
 * Abstract base classe for My.Retail <code>ProductRelationshipsProvider</code>.
 */
public abstract class AbstractRelationshipsProvider implements ProductRelationshipsProvider {
    ...
    public List<ProductRelationship> getRelationships(SlingHttpServletRequest request, CommerceSession session,
        ...
        if (currentPage != null) {
            ...
            if (commerceProvider != null && !commerceProvider.equals(MyRetailConstants.MY_RETAIL_COMMERCEPROVIDER)) {
                return null;
            }
        }
