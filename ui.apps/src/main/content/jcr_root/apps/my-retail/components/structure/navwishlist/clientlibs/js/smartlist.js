...
(function () {
    ...
    var EXPANDABLE_CLASS = 'my-Smartlist-expandable',
    ...
    Vue.component('my-Smartlist-button', {});
    ...
    function init() {
        $('.my-Smartlist').each(function() {
            new SmartlistComponent().$mount(this);
        });
    }

    $(document).bind('my-header-loaded', function() {
        init();
    });
