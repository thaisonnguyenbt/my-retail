 ...
 */
(function ($, document) {
    var $headerContainer = $('.my-retail-header'),
        url = $headerContainer.data('my-header-content');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if($navbar.length) {
                    ...
                    $(document).trigger('my-header-loaded');
                }
            }
        });
    }
    ...
    $(document).on('my-header-loaded', function() {
        unreadCounter($('#my-retail-message-count'),
        ...
        unreadCounter($('#my-retail-notification-count'),
