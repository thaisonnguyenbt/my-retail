...
(function ($) {
    ...
    var bindFormElements = function () {
        // bind form handler
        $('.my-ShoppingCart form, .my-Cart-content form, .my-Product-form').submit(submitForm);
        // submit quantity form on change
        $('.my-ShoppingCart form input[name="quantity"], .my-Cart-content form input[name="quantity"]').change(function () {
    ...
    var toggleCartEmptyMsg = function () {
        if ($('div.my-ShoppingCart div.my-ShoppingCart-empty').length > 0) {
            $('a.btn-checkout').hide();
        } else {
            $('a.btn-checkout').show();
        }
    ...
    var refreshCart = function () {
        var shoppingCart = $('div.my-ShoppingCart');
